-- SQL for en-til-en-eksemplet gjennomgått i F4
...
DROP SCHEMA IF EXISTS f4_kontor_one2one CASCADE;
CREATE SCHEMA f4_kontor_one2one;
SET search_path TO f4_kontor_one2one;

...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\nLager en ny liste [Husarbeid], legger til 3 todos og lagrer ...");
        ...
        husarbeid.setNavn("Gøy husarbeid"); //Endring #1
        husarbeid.fjern(vaskeOpp);          //Endring #2
        husarbeid.leggTil(vaskeVinduer);    //Endring #3
        stovsuge.setTekst("Gøy støvsuging");//Endring #4

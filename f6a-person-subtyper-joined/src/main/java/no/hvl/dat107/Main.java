...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student larsPetter = new Student("81223344559", "Lars-Petter", "Helland", "Informatikk");
        System.out.println();
        System.out.println("Ny Student i main:");
        System.out.println(larsPetter);

        Ansatt petterLars = new Ansatt("86554433224", "Petter-Lars", "Olsen", "Rektor");
        System.out.println();
        ...
        System.out.println(personDAO.finnPersonMedFNr("81223344559"));
        System.out.println(personDAO.finnPersonMedFNr("86554433224"));
